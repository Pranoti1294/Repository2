    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutUser(int userId, [FromBody] UserUpdateDto userUpdateDto)
        {
            if (userId != userUpdateDto.UserId){
                Console.WriteLine("serUpdateDto.UserId : ", userUpdateDto.UserId);
                Console.WriteLine("userId : ", userId);
                return BadRequest();
            }
            Console.WriteLine("updating...");
            Console.WriteLine(_httpContextAccessor.HttpContext.User.FindFirst(ClaimTypes.NameIdentifier)?.Value);
